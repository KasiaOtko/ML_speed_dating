...
##'race', 'race_o', 'field_cd', 'field', 'int_cor', 

tmp = SD
tmp1 <- tmp %>% group_by(pid) %>%
  group_map(~ head(.x$field, 1000))

cols = c("imprelig_o", "imprace_o", "goal_o", "date_o", "go_out_o",  "sports_o", "tvsports_o", "exercise_o", "dining_o", "museums_o", "art_o", "hiking_o","gaming_o", "clubbing_o", "reading_o", "tv_o", "theater_o", "movies_o", "concerts_o", "music_o", "shopping_o", "yoga_o", "exphappy_o") 
